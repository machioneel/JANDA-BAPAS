...
const techSpecs = [
  ...
  { 
    ...
    description: "Inti dari kecerdasan DIGITAL ARCHIVE, memanfaatkan teknologi Artificial Intelligence untuk mengotomatisasi pekerjaan administratif.",
    details: [
      ...
      <div className="grid gap-8 md:grid-cols-3">
        ...
        <div className="md:col-span-2 p-8 bg-card rounded-[2rem] border border-border/50 shadow-xl shadow-black/[0.03]">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-black tracking-tight text-foreground uppercase">DIGITAL ARCHIVE</h2>
          ...
          <div className="space-y-4">
            <p className="text-base leading-relaxed text-foreground/90 font-medium text-justify">
              <span className="font-bold text-foreground">DIGITAL ARCHIVE (Jaringan Arsip Naskah Digital Administrasi Balai Pemasyarakatan)</span> adalah sistem arsip digital berbasis web yang dirancang untuk mengelola seluruh dokumen persuratan administrasi secara terpusat, terstruktur, dan efisien.
            </p>
